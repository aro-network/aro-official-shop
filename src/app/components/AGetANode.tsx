      ...
      <div className={cn("grid grid-cols-3 gap-11 mo:grid-cols-1 mo:gap-5", maxWidthClassName)}>
        <LinerGridentBorder type="2" className="rounded-3xl">
          <div className="px-6 mo:px-4 pt-5 mo:pt-4 pb-12 mo:pb-8 flex flex-col items-center gap-[30px] mo:gap-5">
            <div className="w-full text-white font-medium text-xl mo:text-lg font-Space_Grotesk text-center">1. Install it</div>
        ...
        <LinerGridentBorder type="3" className="rounded-3xl">
          <div className="px-6 mo:px-4 pt-5 mo:pt-4 pb-12 mo:pb-8 flex flex-col items-center gap-[30px] mo:gap-5">
            <div className="w-full text-white font-medium text-xl mo:text-lg font-Space_Grotesk text-center">2. Run it</div>
        ...
        <LinerGridentBorder type="4" className="rounded-3xl">
          <div className="px-6 mo:px-4 pt-5 mo:pt-4 pb-12 mo:pb-8 flex flex-col items-center gap-[60px] mo:gap-8 justify-between">
            <div className="w-full text-white font-medium text-xl mo:text-lg font-Space_Grotesk text-center">3. Start Earning</div>
            <div className="flex flex-col gap-10 mo:gap-6 px-6 mo:px-4 items-center w-full">
  ...
  return (
    <AosAnimItem className="flex justify-center w-full">
      <MBtn
        ...
        className={cn('mt-[52px] mo:mt-8 mb-[124px] mo:mb-16 font-Space_Grotesk text-lg mo:text-base px-12 mo:px-8 py-4 mo:py-3')} 
      />
    </AosAnimItem>
  );
};
     ...
     <div className="min-h-screen w-full bg-[url('/GetANodePicture/bg1.png')] bg-cover bg-no-repeat bg-center">
      ...
      <div className="relative z-10 pb-20 mo:pb-12">
        <div className="pt-[124px] mo:pt-16 pb-16 mo:pb-10">
          <div className="flex flex-col items-center gap-6 mo:gap-4 m-auto max-w-[1600px] w-full px-16 mo:px-6">
